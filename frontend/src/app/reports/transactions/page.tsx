...
export default function TransactionReportsPage() {
  ...
  // Filter reports for transactions only
  const transactionReports = reportData.filter(report => 
    report.title.includes('İşlem') || report.title.includes('Transaction')
  );
  ...
  return (
    <div className="px-4 py-8 min-h-screen bg-gray-50 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-gray-900">İşlem Raporları</h1>
